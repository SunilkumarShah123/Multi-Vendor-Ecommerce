...
class Profile(models.Model):
    ...
    profile_id = models.CharField(
        max_length=10, primary_key=True, default=generate_profile_id, editable=False
    )

    user = models.OneToOneField(User, on_delete=models.CASCADE)

    image = models.FileField(
        upload_to="image/profile/", null=True, blank=True, default="images/default.png"
    )
    ...
    gender = models.CharField(
        max_length=100, null=True, blank=True, choices=gender_choice
    )
